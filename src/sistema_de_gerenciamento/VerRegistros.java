...
public class VerRegistros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gestao_de_taxasPUEntityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("gestao_de_taxasPU").createEntityManager();
        feesDetailsQuery = java.beans.Beans.isDesignTime() ? null : gestao_de_taxasPUEntityManager.createQuery("SELECT f FROM FeesDetails f");
        ...
        columnBinding.setColumnName("Modo de Pagamento");
        columnBinding.setColumnClass(String.class);
    ...
    private java.util.List<sistema_de_gerenciamento.FeesDetails> feesDetailsList;
    private javax.persistence.Query feesDetailsQuery;
    private javax.persistence.EntityManager gestao_de_taxasPUEntityManager;
